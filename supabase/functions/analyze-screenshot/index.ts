    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `Tu es un expert en analyse de conversations de dating. Analyse le screenshot de conversation et retourne un JSON avec exactement cette structure:
{
