...
import { Sparkles, Copy, Check, MessageSquare, Ghost, Heart, Flame } from "lucide-react";
      ...
      <div className="px-4 py-6 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <Input
            ...
            placeholder="Contexte (ex: rencontré en soirée)"
            className="glass border-border/50 rounded-2xl"
          />
          <Button
            onClick={generate}
            disabled={generating}
            className="w-full gradient-primary text-primary-foreground rounded-2xl"
          >
            {generating ? (
